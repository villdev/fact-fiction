...
import logoSm from "../images/fflogo-sm.svg";
...
export default function Header() {
  ...
  const isNotSmallMobileScreen = useMediaQuery({ minWidth: 576 });
        ...
        <nav className="nav header-container-75">
          {isDesktopOrLaptop ? (
            ...
            <div className="menu-wrapper">
              ...
              >
                <div className="menu" onClick={() => showSidebar(true)}>
                  <span className="menu__icon">
                    ...
                    >
                      <path
                        d="M19.68 10.8H4.32C3.6576 10.8 3.6 11.3364 3.6 12C3.6 12.6636 3.6576 13.2 4.32 13.2H19.68C20.3424 13.2 20.4 12.6636 20.4 12C20.4 11.3364 20.3424 10.8 19.68 10.8V10.8ZM19.68 15.6H4.32C3.6576 15.6 3.6 16.1364 3.6 16.8C3.6 17.4636 3.6576 18 4.32 18H19.68C20.3424 18 20.4 17.4636 20.4 16.8C20.4 16.1364 20.3424 15.6 19.68 15.6V15.6ZM4.32 8.4H19.68C20.3424 8.4 20.4 7.8636 20.4 7.2C20.4 6.5364 20.3424 6 19.68 6H4.32C3.6576 6 3.6 6.5364 3.6 7.2C3.6 7.8636 3.6576 8.4 4.32 8.4Z"
                        fill="black"
                      />
                    </svg>
                  </span>
